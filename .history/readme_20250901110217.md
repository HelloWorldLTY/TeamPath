...
The most important thing is to install verl. Please install the platform directly from our folder **rl_train**. We have specified the version of verl. You can also go to check `2bd291e5494db03ba358ef279a334c2f0829b979` of the verl codebase for the best compatibility (new versions have not been tested yet).
