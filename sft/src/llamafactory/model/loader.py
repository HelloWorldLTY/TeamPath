...
def load_tokenizer(model_args: "ModelArguments") -> "TokenizerModule":
    ...
    if "pathor1_revised" in model_args.model_name_or_path or "Patho-R1" in model_args.model_name_or_path:
    #     new_tokens_to_add = pd.read_csv("/nfs/roberts/project/pi_hz27/tl688/LLaMA-Factory/data/idc_gene_token.csv")
    #     new_tokens_to_add = new_tokens_to_add['genes'].values
